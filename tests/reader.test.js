          ...
          menu: {
            metas: {
              root: {
                restaurant: {
                  id: 71729,
                  name: 'Wagamama - Westminster',
                  uname: 'wagamama-westminster',
                  drnId: 'uuid-1',
                  brandDrnId: 'brand-uuid-1',
                  location: {
                    address: {
                      address1: '23 Victoria Street, Westminster, London, SW1H 0NL',
...
describe('getPageType', () => {
  it('returns listing for /restaurants/ paths', () => {
    setPathname('/restaurants/london/westminster');
    expect(getPageType()).toBe('listing');
  });

  it('returns detail for /menu/ paths', () => {
    setPathname('/menu/london/westminster/wagamama');
